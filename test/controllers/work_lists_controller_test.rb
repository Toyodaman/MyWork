...
class WorkListsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create work_list" do
    assert_difference('WorkList.count') do
      post work_lists_url, params: { work_list: { date: @work_list.date, work: @work_list.work } }
    end
  ...
  test "should update work_list" do
    patch work_list_url(@work_list), params: { work_list: { date: @work_list.date, work: @work_list.work } }
